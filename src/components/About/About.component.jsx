...
export default function About(){
    return(
     <div className='bg-purple-pry dark:bg-white pb-14 md:pb-0 lg:p-16'id='about'>
         <h1 className='flex justify-center text-white dark:text-black text-3xl font-bold mb-8 rounded-lg'>About</h1>
         <div className='flex '>
             ...
             <div className={`w-2/4  shadow-lg p-5 rounded-lg bg-purple-sec dark:bg-green-high ml-5 h-2/4 ${styles.animate} lg:w-1/4`}>
                 ...
                 <div className='flex justify-center'>
                     <img src='arnold.jpeg' alt='image of Arnold Amasoh' className='rounded-lg max-h-40' />
                 </div>
                 <div className='mt-4'>
