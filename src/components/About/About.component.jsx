    ...
    return(
     <div className='bg-white dark:bg-purple-pry lg:p-16 mb-24'>
         ...
         <div className='flex '>
             ...
             <div className={`w-2/4  shadow-lg p-5 rounded-lg bg-purple-sec ml-5 h-2/4 ${styles.animate} lg:w-1/4`}>
             ...
             <div className='text-purple-txt text-xl w-2/4 ml-5 md:hidden tracking-wider'>
             ...
             <div className='hidden md:block tracking-wider leading-relaxed text-purple-txt w-2/4 ml-5 lg:w-4/6 lg:pl-14'>
               ...
               <div className='text-purple-txt p-4 leading-relaxed  md:hidden'>
